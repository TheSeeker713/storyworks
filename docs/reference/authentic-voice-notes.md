...
This document exists so any AI model working on Storyworks (or another
project of Jeremy's) can write first-person content — especially
`docs/devlogs/` entries — as Jeremy Robards' own words without it
reading as AI-generated. Hand this to a model as context before it
writes anything in this voice.
