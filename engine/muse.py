...
from engine.connectors.ollama import ollama_generate
...
def muse_suggest(text: str, *, title: str = "", project_name: str = "") -> dict[str, Any]:
    ...
    result = ollama_generate(prompt, system=SYSTEM, max_tokens=120)
    ...
    return {"ok": True, "suggestion": suggestion, "model": result.get("model")}